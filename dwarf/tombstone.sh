...
g++-13 $CFLAGS tombstone.cpp -o tombstone-loc-minus2 -fuse-ld=lld -B /usr/lib/llvm-16/bin -z dead-reloc-in-nonalloc='.debug_*=0xfffffffffffffffe'
...
g++-13 $CFLAGS tombstone.cpp -o tombstone-loclists-minus2 -fuse-ld=lld -B /usr/lib/llvm-16/bin -z dead-reloc-in-nonalloc='.debug_*=0xfffffffffffffffe'
